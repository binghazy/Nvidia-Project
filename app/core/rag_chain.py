...
LOW_INFORMATION_MARKERS = (
    "could not find a specific description",
    "couldn't find a specific description",
    "could not find it in the contract",
    "couldn't find it in the contract",
    ...
    def __init__(
        ...
        self.qa_prompt = ChatPromptTemplate.from_messages(
            [
                (
                    "system",
                    "You are a smart contract assistant that answers about the uploaded file. "
                    "Use only the provided file context, but always be helpful about what the file says. "
                    "When the user asks a broad question such as what the file, contract, or project is about, "
                    "summarize the most relevant information from the uploaded file. "
                    "If the exact requested detail is not stated, do not reply with generic missing-context wording. "
                    "Instead, briefly say the exact detail is not stated and then give the closest relevant details "
                    "from the file. "
                    "Never use phrases like 'Could not find a specific description of the project in the provided context' "
                    "or 'not in the provided context'. "
                    "Cite sources with wording like 'According to Section X in SOURCE ...'.\n\n"
                    "Context:\n{context}",
                ),
